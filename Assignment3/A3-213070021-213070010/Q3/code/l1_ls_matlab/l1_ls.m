...
defaults   = {1e-3,false,1e-3,5000,zeros(n,1),ones(n,1),t0}; % Changed dimension of x from zeros(n,1), ones(n,1) to zeros(n,n), ones(n,n)
...
%     disp(["At term 1: ", size(At*(z*2))])
%     disp(["At term 2: ", size((q1-q2)/t)])
